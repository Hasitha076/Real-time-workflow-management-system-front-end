...
const InviteActionMembers = ({ setInvitePopup, id, icons, setIcons, activeAction, setActiveAction }) => {
  ...
  const getAvailableUsers = async () => {
    ...
    useEffect(() => {
        const matchingUsers = availableusers.filter((user) => user.userId === icons[0]?.id)
          .map((user) => ({
            id: user.userId,
            name: user.userName,
            email: user.email,
